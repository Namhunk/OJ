...
2. [숫자 야구](https://school.programmers.co.kr/learn/courses/30/lessons/451808)
3. [리프 노드 수 최대화](https://school.programmers.co.kr/learn/courses/30/lessons/468372)

<sub>매일 자정(KST) 자동 갱신 · 다시 뽑기: Actions → 해당 워크플로 → Run workflow(reroll 체크)</sub>
<!-- TODAY:END -->

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/heatmap-dark.svg?v=1790363371">
  <img alt="이 저장소 풀이 잔디" src="assets/heatmap-light.svg?v=1790363371">
</picture>
